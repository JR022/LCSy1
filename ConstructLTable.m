%The function that returns the table of L-values to find the length of the
%longest common subsequence between a and b.
function LTable = ConstructLTable(a,b)
    %       ___ ___ ___
    %  b(n)|___|___|___|
    %  ... |___|___|___|
    %  b(1)|___|___|___|
    ...
    %Note that output needs to be 'rotated' 90 degrees CCW
